    ...
    <section className="py-16 sm:py-20 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto bg-gradient-to-br from-green-800 via-green-700 to-emerald-800 rounded-[2rem] p-12 sm:p-16 text-center relative overflow-hidden shadow-2xl shadow-green-900/30">
        ...
        <div className="relative z-10">
          ...
          <a
            href="/login"
            className="hover-pulse inline-flex items-center gap-3 bg-white text-green-800 font-black text-xl px-10 py-5 rounded-2xl shadow-2xl hover:-translate-y-1 transition-all"
          >
            MASUK DASHBOARD <ArrowIcon c="w-6 h-6" />
          </a>
        </div>
      </div>
    </section>
