        ...
        <div className="w-full bg-white/95 rounded-[32px] shadow-2xl shadow-gray-200/80 border border-gray-100 p-8 sm:p-10 relative overflow-hidden transition-all duration-300 hover:shadow-gray-300/60">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="pt-2 flex flex-col gap-3">
              ...
              <Link
                href="/"
                className="w-full inline-flex items-center justify-center gap-2.5 px-6 py-4 text-base font-bold bg-white text-gray-600 hover:text-green-700 hover:bg-green-50/20 border border-gray-200 hover:border-green-300 shadow-sm rounded-xl transition-all duration-300 group"
              >
